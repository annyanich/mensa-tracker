...
from email_alerter.email_alerter import search_hits_to_emails, run_all_searches_for_today
from email_alerter import celery_tasks

if __name__ == '__main__':
    for recipient, subject, body in search_hits_to_emails(run_all_searches_for_today()):
